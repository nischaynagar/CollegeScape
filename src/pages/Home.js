    ...
    <div className={design.main} id="features">
      <div className={design.NavContainer}>
        ...
        <Link
          ...
          duration={1000}
        >
          <Button className={design.NavButton1} style={ButtonStyle}>
            Features
          </Button>
        </Link>

        <Link
          className={design.NavButton2}
          style={ButtonStyle}
          activeClass="active"
          to="team"
          spy={true}
          ...
          duration={1000}
        >
          <Button className={design.NavButton2} style={ButtonStyle}>
            Team
          </Button>
        </Link>
        <Link
          ...
          duration={1000}
        >
          <Button className={design.NavButton3} style={ButtonStyle}>
            Contact Us
          </Button>
        </Link>
      ...
      <div className={design.MobileNav}>
        ...
        <div className={design.MobileNavMiddle}>
          <Link
            ...
            duration={1000}
          >
            <Button className={design.MNavButton1} style={ButtonStyle}>
              Features
            </Button>
          </Link>

          <Link
            className={design.MNavButton2}
            style={ButtonStyle}
            activeClass="active"
            to="team"
            spy={true}
            ...
            duration={1000}
          >
            <Button className={design.MNavButton2} style={ButtonStyle}>
              Team
            </Button>
          </Link>
          <Link
            ...
            duration={1000}
          >
            <Button className={design.MNavButton3} style={ButtonStyle}>
              Contact Us
            </Button>
          </Link>
        </div>
      ...
      <div className={design.body}>
        <div className={design.FeaturesContainer} id="features">
          ...
          <div className={design.Feature1}>
            <h2 className={design.FeatureSubtitle}>
              A One stop platform to manage academic affairs and student
              database!
            </h2>
            <p className={design.img__description}>
        ...
        <div className={design.TeamContainer} id="team">
          <div className={design.TeamTitleContainer}>
            <h1 className={design.TeamHeading}>
              Meet the <span className={design.TeamTeamHeadingBold}>Team</span>
            </h1>
            <img
              src={teamIllustration}
              alt="team illustration"
              className={design.TeamIllustrationImage}
            />
          </div>
          <div className={design.TeamInfoContainer}>
            <div>
              <div
                className={`${design.TeamMemberWrapper} ${design.TeamMemberWrapper1}`}
              >
                <img
                  src={team1}
                  alt="team member 1"
                  className={`${design.TeamMember} ${design.TeamMember1}`}
                />
              </div>

              <div
                className={`${design.TeamMemberWrapper} ${design.TeamMemberWrapper2}`}
              >
                <img
                  src={team2}
                  alt="team member 2"
                  className={`${design.TeamMember} ${design.TeamMember2}`}
                />
              </div>
            </div>
            ...
            <div>
              <div
                className={`${design.TeamMemberWrapper} ${design.TeamMemberWrapper3}`}
              >
                <img
                  src={team3}
                  alt="team member 3"
                  className={`${design.TeamMember} ${design.TeamMember3}`}
                />
              </div>

              <div
                className={`${design.TeamMemberWrapper} ${design.TeamMemberWrapper4}`}
              >
                <img
                  src={team4}
                  alt="team member 4"
                  className={`${design.TeamMember} ${design.TeamMember4}`}
                />
              </div>
            </div>
          </div>
      ...
      <div className={design.contact} id="contact">
        <img src={facebook} alt="facebook" className={design.contactlogo} />
        <img src={twitter} alt="facebook" className={design.contactlogo} />
        <img src={instagram} alt="facebook" className={design.contactlogo} />
      </div>
