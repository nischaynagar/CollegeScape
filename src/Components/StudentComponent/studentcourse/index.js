        ...
        <div>
            <div className={design.overview}>
                ...
                <div className={design.heading}>
                    <p className={design.title}>Student ka course</p>
                ...
                <div className={design.coursebox}>
                    <p className={design.coursename}>DAA - (Dynamic Programming of Algorithm and Analysis)</p>
                    <p className={design.faculty}>Assigned faculty : R.Kala</p>
                    <p className={design.semester}>BTech IT Sem 4</p>
                    <div className={design.resultbox}>
                        ...
                        <div className={design.cgpabox}>
                            <div className={design.gradebox}>
                                <p className={design.firstone}>Current CGPA</p>
                                <p className={design.secondone}>8.33</p>
                            </div>
                            <div className={design.gradebox}>
                                <p className={design.firstone}>C1</p>
                                <p className={design.secondone1}>25/30</p>
                            </div>
                            <div className={design.gradebox}>
                                <p className={design.firstone}>C2</p>
                                <p className={design.secondone1}>29/30</p>
                            </div>
                            <div className={design.gradebox}>
                                <p className={design.firstone}>C3</p>
                                <p className={design.secondone1}>32/40</p>
                            </div>
                        </div>
                    </div>
                </div>
